...
<link href="/backend/icatalogo3/icatalogo/icatalogo-parte3/componentes/header/header.css" rel="stylesheet" />
<?php
...
<header class="header">
   <figure>
       <img src="/backend/icatalogo3/icatalogo/icatalogo-parte3/imgs/logo.png">
   </figure>
        ...
        <h1>Fazer login</h1>
        <form  method="POST" action="/backend/icatalogo3/icatalogo/icatalogo-parte3/componentes/header/acoesLogin.php">
    ...
    ?>
      ...
      <form id="form-logout"form method="POST" style= "display: none" action="/backend/icatalogo3/icatalogo/icatalogo-parte3/componentes/header/acoesLogin.php">
